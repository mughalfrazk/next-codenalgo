  ...
  return (
    <form action={formAction} className="grid grid-cols-2 gap-4" noValidate>
      ...
      <div className="col-span-2 sm:col-span-1">
        ...
        <input id="company" name="company" type="text" placeholder="Company" className={inputClass} />
      </div>
      ...
      <div className="col-span-2">
        <label className="flex items-center gap-2.5 text-[13px] font-medium text-muted">
          <input type="checkbox" name="consent" className="h-4 w-4 accent-[#8B7CF6]" />
      ...
      <div className="col-span-2 text-[12px] leading-[1.5] font-medium text-muted-2" aria-live="polite">
        {state.message && !done
          ? state.message
