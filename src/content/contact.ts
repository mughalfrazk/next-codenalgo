...
export const contactFaq: QA[] = [
  ...
  { q: "Do you sign NDAs?", a: "Yes — we're happy to sign an NDA before discussing project details." },
  { q: "Do you work with international clients?", a: "Yes, most of our clients are outside the UK — we work across time zones as standard." },
];
