...
export const services: Service[] = [
  {
    ...
    processSteps: [
      {
        ...
        desc: 'We analyze your business goals, pain points, and current data infrastructure to identify high-impact AI/ML opportunities.',
      },
      {
        n: 2,
        title: 'Feasibility & Data Assessment',
        desc: 'We assess data readiness, clean datasets, and establish the requirements needed to train accurate, reliable models.',
      },
      {
        n: 3,
        title: 'Training & Validation',
        desc: 'Models go through several layers of checks to ensure performance and accuracy before release, enabling immediate feedback.',
      },
      {
        n: 4,
        title: 'Deployment & Integration',
        desc: 'We seamlessly integrate models into your workflows, dashboards, or products — cloud-based or on-premises.',
      },
      {
        n: 5,
        title: 'Monitoring & Optimization',
        desc: 'We keep monitoring and refining so your models adapt to your business and keep performing.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        q: 'Do we need a large dataset to start?',
        a: 'Not always — we can start with pre-trained models and fine-tune, or design a data-collection strategy alongside the build.',
      },
      {
        q: 'Can you integrate AI into our existing product?',
        a: 'Yes — most engagements embed models and inference APIs into an existing application rather than starting from scratch.',
      },
      {
        q: 'How do you keep models accurate over time?',
        a: 'We set up monitoring and automated retraining pipelines so performance holds as your data shifts.',
      },
      {
        q: 'Do you work with LLMs?',
        a: 'Yes — we build retrieval-augmented and agentic LLM applications with the latest Claude models and open-source options.',
      },
    ],
    ...
    processSteps: [
      {
        ...
        desc: 'We map requirements, information architecture, and the tech stack.',
      },
      {
        n: 2,
        title: 'Design the UI',
        desc: 'Accessible, on-brand interfaces that fit how your users actually work.',
      },
      {
        n: 3,
        title: 'Build & Integrate',
        desc: 'Clean, tested code wired into your data, auth, and third-party tools.',
      },
      {
        n: 4,
        title: 'Launch & Iterate',
        desc: 'Robust deployment pipelines with monitoring and fast iteration.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        ...
        a: 'Yes — most engagements extend or modernize an existing system rather than starting from scratch.',
      },
      {
        q: 'Do you handle both frontend and backend?',
        a: 'Yes — we deliver full-stack, from UI to APIs, databases, and infrastructure.',
      },
      {
        q: 'Will the site be SEO-friendly?',
        a: 'We build with server rendering, semantic markup, and performance best practices so search engines index you well.',
      },
      {
        q: 'Do you provide ongoing maintenance?',
        a: 'Every project includes a post-launch support window, with retainers available after that.',
      },
    ],
    ...
    processSteps: [
      {
        ...
        desc: 'We shape the concept, flows, and a clickable prototype.',
      },
      {
        n: 2,
        title: 'Design the Experience',
        desc: 'Intuitive, platform-native interfaces that feel effortless.',
      },
      {
        n: 3,
        title: 'Build & Test',
        desc: 'Performant code with device testing across the matrix.',
      },
      {
        n: 4,
        title: 'Ship & Support',
        desc: 'Store submission, release management, and post-launch care.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        ...
        a: 'It depends on your performance needs and budget; we help you weigh the tradeoffs and pick the best fit.',
      },
      {
        q: 'Can you publish to the App Store and Play Store for us?',
        a: 'Yes — we manage store submission, review, and release on your behalf.',
      },
      {
        q: 'Do you build the backend too?',
        a: 'Yes — we deliver the APIs, auth, and infrastructure your app relies on.',
      },
      {
        q: 'What about updates after launch?',
        a: 'We offer ongoing maintenance and feature retainers to keep your app current.',
      },
    ],
    ...
    processSteps: [
      {
        ...
        desc: 'We collaborate to learn about your workflows, challenges, and goals, then create a success-oriented roadmap.',
      },
      {
        n: 2,
        title: 'Tailored Implementation',
        desc: "Our certified specialists tailor your selected platform to your specific requirements — we don't do generic.",
      },
      {
        n: 3,
        title: 'Smart Integrations',
        desc: 'We synchronize your digital ecosystem, ensuring data flows easily, faster processes, and scalable growth.',
      },
      {
        n: 4,
        title: 'Performance Optimization',
        desc: 'After launch, we focus on optimizing performance, addressing issues, and ensuring seamless user adoption.',
      },
      {
        n: 5,
        title: 'Long-term Framework & Innovation',
        desc: 'As your enterprise scales, we scale your systems — deploying new modules, automation, and insights.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        ...
        a: 'Odoo, Salesforce, Microsoft Dynamics 365, SAP, and others — we recommend the right fit for your needs.',
      },
      {
        q: 'Can you integrate with our existing tools?',
        a: 'Yes — integration and data migration between systems is a core part of what we do.',
      },
      {
        q: 'How do you minimize downtime during migration?',
        a: 'We use phased, tested migrations with rollback plans to keep operations running.',
      },
      {
        q: 'Do you provide training?',
        a: 'Yes — we onboard your team and document the system so adoption sticks.',
      },
    ],
  ...
  },
  {
    ...
    processSteps: [
      {
        ...
        desc: 'We understand the gaps in your team, workloads, and timelines.',
      },
      {
        n: 2,
        title: 'Talent Match',
        desc: 'We filter through hundreds of developers or support personnel to find the right fit for your requirements.',
      },
      {
        n: 3,
        title: 'Seamless Integration',
        desc: 'All of our resources function as an extension of your team in your toolsets and processes.',
      },
      {
        n: 4,
        title: 'Active Oversight',
        desc: 'Continuous evaluation of performance and delivery.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        q: 'How fast can you place a developer?',
        a: 'Typically within one to two weeks, depending on the specific skill set required.',
      },
      {
        q: 'Can we interview candidates first?',
        a: 'Yes — we shortlist candidates and you interview and approve before they join.',
      },
      {
        q: 'Is this a full-time or part-time engagement?',
        a: 'Both — engagements can be full-time or scaled to part-time based on your needs.',
      },
      {
        q: "What happens if it's not a good fit?",
        a: 'We swap the resource at no extra cost during the trial period.',
      },
    ],
    ...
    processSteps: [
      {
        ...
        desc: 'We assess your present setup, business objectives, and risk appetite to create a customized strategy.',
      },
      {
        n: 2,
        title: 'Cloud Architecture & DevOps',
        desc: 'We architect and automate your cloud ecosystem for peak performance and scalability using IaC.',
      },
      {
        n: 3,
        title: 'Cybersecurity Fortification',
        desc: 'Multiple layers of protection to secure your data, networks, and apps — with proactive penetration testing.',
      },
      {
        n: 4,
        title: 'Quality Assurance Integration',
        desc: 'End-to-end QA embedded in your development lifecycle — quality baked into every phase.',
      },
      {
        n: 5,
        title: 'Continuous Optimization',
        desc: 'Continuous monitoring, automated improvement, and real-time insight to keep systems at peak performance.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        ...
        a: 'AWS, Azure, and GCP — plus hybrid and on-prem setups.',
      },
      {
        q: 'Can you migrate us with zero downtime?',
        a: 'Yes — we use phased, tested migrations designed to avoid service interruption.',
      },
      {
        q: 'Do you offer 24/7 monitoring?',
        a: 'Yes — round-the-clock NOC and SOC monitoring with alerting and incident response is standard.',
      },
      {
        q: 'What cybersecurity services are included?',
        a: 'Penetration testing, DDoS mitigation, threat response, and compliance alignment with GDPR, HIPAA, and other standards.',
      },
    ],
    ...
    processSteps: [
      {
        ...
        desc: 'We understand your products, customers, and business model to design the right commerce solution.',
      },
      {
        n: 2,
        title: 'Design & UX',
        desc: 'Mobile-first, conversion-focused designs with customer journey mapping and A/B testing strategies.',
      },
      {
        n: 3,
        title: 'Build & Integrate',
        desc: 'Custom development with CRM, ERP, payment gateways, and multi-channel integrations.',
      },
      {
        n: 4,
        title: 'Launch & Optimize',
        desc: 'SEO-optimized launch, performance tuning, and ongoing support for long-term growth.',
      },
    ],
    benefits: [
    ...
    faq: [
      {
        ...
        a: 'Shopify, Magento, WooCommerce, BigCommerce, and fully custom platforms — we recommend the best fit for your scale and requirements.',
      },
      {
        q: 'Can you integrate our existing CRM or ERP?',
        a: 'Yes — we integrate with Salesforce, HubSpot, Odoo, Dynamics 365, SAP, and custom systems.',
      },
      {
        q: 'Do you handle payment gateway setup?',
        a: 'Yes — including Stripe, PayPal, Apple Pay, Google Pay, and Buy Now Pay Later solutions like Klarna and Clearpay.',
      },
      {
        q: 'Can you migrate from our current platform?',
        a: 'Yes — we handle full platform migrations including product data, customer records, and order history with minimal disruption.',
      },
    ],
...
export function relatedServices(slug: string): Service[] {
  ...
  if (!svc) return []
  return svc.relatedSlugs.map((s) => getService(s)).filter((s): s is Service => Boolean(s))
}
...
export const servicesFaq: QA[] = [
  {
    ...
    a: 'We start with a discovery call to understand goals and constraints, then return a fixed-scope proposal or a time-and-materials estimate depending on how well-defined the requirements are.',
  },
  {
    q: "What's a typical engagement length?",
    a: 'Most projects run 8–16 weeks end to end. Dedicated-team and staff-augmentation engagements are ongoing and billed monthly.',
  },
  {
    q: 'Can you work with our existing codebase?',
    a: 'Yes — most of our engagements involve extending or modernizing an existing system rather than starting from scratch.',
  },
  {
    q: 'How do you handle IP and confidentiality?',
    a: 'All engagements start with an NDA, and all IP created during the engagement belongs to you.',
  },
  {
    q: 'What happens after launch?',
    a: 'Every project includes a post-launch support window, with ongoing maintenance retainers available after that.',
  },
]
